...
When I enter `#{generate(Name.firstName)}` in field located `By.xpath(//*[@name="customerName"])`
When I enter `#{generate(regexify '[a-z]{6}[A-Z]{2}')}@test.com` in field located `By.xpath(//*[@name="email"])`
When I enter `randompassword123` in field located `By.xpath(//*[@name="password"])`
When I enter `randompassword123` in field located `By.xpath(//*[@name="passwordCheck"])`
